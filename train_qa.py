...
from qa.qa_dataset import QADataset, qa_collate, MhopSampler
from qa.qa_model import QAModel
from qa.utils import AverageMeter, move_to_cuda, get_final_text

from qa.hotpot_evaluate_v1 import f1_score, exact_match_score, update_sp
...
def eval_final(args, model, eval_dataloader, weight=0.8, gpu=True):
    ...
    # print(f"QA cross-attention avg time: {np.mean(encode_times)}")
