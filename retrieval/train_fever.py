"""
## Multihop FEVER Retrieval Training

CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python train_fever.py \
    --do_train \
    --prefix fever_fix_duplicated_title \
...
from data.mhop_dataset import mhop_collate
from data.fever_dataset import FeverDataset
from models.mhop_retriever import RobertaRetriever
from utils.utils import AverageMeter, move_to_cuda, load_saved
...
def main():
    ...
    model_name = f"{args.prefix}-seed{args.seed}-bsz{args.train_batch_size}-fp16{args.fp16}-lr{args.learning_rate}-decay{args.weight_decay}-warm{args.warmup_ratio}-valbsz{args.predict_batch_size}-shared{args.shared_encoder}"
